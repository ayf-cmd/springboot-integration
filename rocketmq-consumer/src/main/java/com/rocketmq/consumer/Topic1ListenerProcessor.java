 ...
 */
@Component
public class Topic1ListenerProcessor implements MessageListenerConcurrently {
    private static final Logger logger = LoggerFactory.getLogger(Topic1ListenerProcessor.class);
