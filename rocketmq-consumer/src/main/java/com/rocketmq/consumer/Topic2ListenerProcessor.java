 ...
 */
@Component
public class Topic2ListenerProcessor implements MessageListenerConcurrently {
    private static final Logger logger = LoggerFactory.getLogger(Topic2ListenerProcessor.class);
