...
public class Topic2Config {
    ...
    // 主题
    private String topic = "credit-report-cgq";
    // tag
    private String tag = "*";
    // groupName
    private String groupName = "credit-report-cgq-group";

    @Autowired
    private Topic2ListenerProcessor topic2ListenerProcessor;
    ...
    public DefaultMQPushConsumer getRocketMQConsumer() {
        try {
            ...
            consumer.registerMessageListener(topic2ListenerProcessor);
            /**
